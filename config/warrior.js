...
*/
	...
	// AddedOrRefreshed: Shadow of the Tempest I
	{
		...
		message: '{icon}{blue} Shadow of the Tempest {stacks} stack(s)',
		required_stacks: 45
	},
	// Added: Shadow of the Tempest I
	{
		...
		message: '{icon}{lightblue} Shadow of the Tempest I'
	},
	// Added: Shadow of the Tempest II
	{
		...
		message: '{icon}{lightblue} Shadow of the Tempest II'
	},
	// Expiring: Shadow of the Tempest II
	{
		...
		message: '{icon}{orange} Shadow of the Tempest {duration}',
		time_remaining: [0,2,4,6]
	},
